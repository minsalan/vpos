...
CROSSTOOL = arm-none-eabi-
CC = $(CROSSTOOL)gcc
OC = $(CROSSTOOL)objcopy
LD = $(CROSSTOOL)ld

INCLUDE = -I. -I$(TOPDIR)/include -I$(TOPDIR)/hal/include -I$(TOPDIR)/fs/include -I/opt/toolchains/gcc-arm-none-eabi-6-2017-q2-update/arm-none-eabi/bin
